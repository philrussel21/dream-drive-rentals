...
import type {PerkCardProps as PerkCardProperties} from '../perk-card';
...
type WhyUsProperties = {
  ...
  perks: PerkCardProperties[];
};

const WhyUs = ({heading, subheading, content, image, perks}: WhyUsProperties): JSX.Element => (
