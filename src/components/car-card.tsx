...
const CarCard = ({id, model, make, image, price, year, capacity, transmission, fuelType, location, onClick}: CarCardProperties): JSX.Element => {
	...
	return (
		<article>
			...
			<div className="p-3 bg-brand-charcoal text-brand-gold flex justify-between items-center space-x-2">
				...
				<Button.Semantic label="Select" className="w-full block" onClick={handleOnClick}/>
			</div>
